...
class UpdateUserRequest extends FormRequest
{
     ...
     */
    //metodo para reglas de validacion al actualizar usuarios
    public function rules(): array
    {
        return [
            //reglas de validacion para actualizar usuarios
            'name' => $this->user()->hasRole('admin')
            ? 'sometimes|required|string|max:255'
            : 'prohibited', // está prohibido para otros roles

            // el email no se puede actualizar
            'email' => 'prohibited', 
            'password' => 'sometimes|required|string|min:8|confirmed',
            'profile_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'role' => 'sometimes|required|string|in:admin,profesor,estudiante',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'email.prohibited' => 'El correo electrónico no se puede actualizar.',
